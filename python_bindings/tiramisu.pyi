...
class computation:
    ...
    @overload
    def interchange(self, l0: var, l1: var) -> None: ...
    @overload
    def interchange(self, l0: int, l1: int) -> None: ...
    def set_expression(self, arg0: expr) -> None: ...
    @overload
    def split(self, arg0, size: int) -> None: ...
    @overload
    def split(self, arg0, size: int, outer, inner) -> None: ...
    @overload
    ...
    @overload
    def split(self, l0: var, size: int) -> None: ...
    @overload
    def split(self, l0: int, size: int) -> None: ...
    @overload
    def split(self, l0: var, size: int, outer: var, inner: var) -> None: ...
    @overload
    def tag_distribute_level(self, l: int) -> None: ...
    @overload
    def tag_distribute_level(self, l: var) -> None: ...
    @overload
...
class function:
    ...
    def codegen(self, arguments: List[buffer], obj_filename: str, arch: int, gen_python: bool) -> None: ...
    def dump(self, exhaustive: bool) -> None: ...
    def dump_dep_graph(self) -> None: ...
    def dump_iteration_domain(self) -> None: ...
    def dump_time_processor_domain(self) -> None: ...
    def dump_halide_stmt(self) -> None: ...
    def gen_isl_ast(self) -> None: ...
...
def get_implicit_function(*args, **kwargs) -> function: ...
def init(arg0: str) -> None: ...
def memcpy(arg0, arg1) -> expr: ...
@overload
def pycodegen(arg0: List[buffer], name: str, cuda: bool) -> None: ...
@overload
def pycodegen(arg0: List[buffer], name: str, arg2: hardware_architecture_t, cuda: bool) -> None: ...
